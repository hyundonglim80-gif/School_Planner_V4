                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {linkCount > 0 && (
                        <button 
                          ...
                          className="bg-yellow-100 text-yellow-800 text-[11px] px-1.5 py-0.5 rounded font-bold border border-yellow-300 ml-1 hover:bg-yellow-200 cursor-pointer"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <div className="flex flex-col">
                      <span className="text-slate-400 text-[11px] mb-0.5">📝 수업 메모</span>
                      <p className="text-slate-600 whitespace-pre-wrap leading-relaxed">
                        {item.memo || item.content || <span className="text-slate-300">없음</span>}
                      </p>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-slate-400 text-[11px] mb-0.5">📌 비고 / 준비물</span>
