      ...
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-full" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 overflow-y-auto overscroll-contain space-y-5 flex-1 min-h-0" data-scroll-lock>
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
            ...
            {/* 방학 기간에서 계산된 학기 */}
            <div className="mt-3 bg-white/70 border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-600 space-y-0.5">
              <div>
            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="px-2 py-1 bg-white hover:bg-emerald-100 text-emerald-800 text-xs font-bold rounded border border-emerald-300"
                >
                  1학기 기간 채우기
                </button>
                <button
