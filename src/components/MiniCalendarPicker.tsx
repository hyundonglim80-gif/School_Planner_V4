    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex justify-between items-center mb-1.5 pb-1 border-b border-slate-100">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="px-1.5 py-0.5 text-[11px] font-bold bg-blue-50 hover:bg-blue-100 text-blue-600 border border-blue-200 rounded transition-colors cursor-pointer"
              >
                오늘
              </button>
              <button
          ...
          {/* 2. 요일 헤더 */}
          <div className="grid grid-cols-7 mb-1 pb-1 border-b border-slate-100 text-center text-[11px] font-bold">
            {weekDays.map((w, idx) => {
              const colorClass =
                idx === 0
                  ? 'text-rose-500'
          ...
          {/* 4. 하단 직접 선택 */}
          <div className="flex justify-between items-center mt-1.5 pt-1.5 border-t border-slate-100 text-[11px]">
            ...
            <span className="text-[10px] text-slate-400">클릭 시 이동</span>
          </div>
        </div>
      )}
    </div>
