          ...
          <div className="flex justify-between items-center mb-1.5 pb-1 border-b border-slate-100">
            <div className="flex items-center gap-0.5">
              <button
                ...
                className="px-1 py-0.5 text-xs text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded transition-colors cursor-pointer"
                title="이전 연도"
              >
                «
              </button>
              <button
                ...
                className="px-1 py-0.5 text-xs text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded transition-colors cursor-pointer"
                title="이전 달"
              >
                ◀
              </button>
